...
var squad: Array = [
#	{"unit": Unit.new(Unit.BASE.OLYMPIAN_APOLLO), "start_position": Vector2(400, 720-100)},
#	{"unit": Unit.new(Unit.BASE.OLYMPIAN_ARES), "start_position": Vector2(400, 720-100)},
...
#	{"unit": Unit.new(Unit.BASE.OLYMPIAN_HERMES), "start_position": Vector2(400, 720-100)},
#	{"unit": Unit.new(Unit.BASE.OLYMPIAN_ZEUS), "start_position": Vector2(400, 720-100)},
